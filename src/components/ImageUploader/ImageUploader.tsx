...
interface ImageUploaderProps {
    initialImage?: { url: string; key: string } | null;
    onImageUpload: (image: { url: string; key: string } | null) => void;
    onDelete: (image: { url: string; key: string } | null) => void;
    height?: string;
    uploadText?: string;
    subText?: string;
}
            ...
            {image && image.url ? (
                <div className="relative group">
                    <img
                        src={image.url}
                        alt="Preview"
                        className={`rounded-lg object-cover w-full border-2 border-dashed border-gray-300 shadow-sm ${height}`}
                    />
                    <button
                        type="button"
                ...
                <label
                    ...
                    ${
                        isUploading
                            ...
                            : "bg-gray-50 border-gray-300 hover:border-[#22ae4b] hover:bg-[#22ae4b]/5"
                    }
                    transition-colors duration-200 overflow-hidden relative ${height}
                `}
                >
                    {isUploading ? (
                        <div className="flex flex-col items-center justify-center">
                            <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-[#22ae4b] mb-3"></div>
                        ...
                        <div className="flex flex-col items-center justify-center pt-5 pb-6 px-4 text-center">
                            ...
                            <p className="mb-2 text-sm text-gray-500">
                                <span className="font-semibold text-[#22ae4b]">{uploadText}</span>
                            </p>
                        ...
                        <div className="p-4 bg-gray-50 border-t">
                            ...
                            <div className="flex justify-end space-x-3">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-medium text-white bg-[#22ae4b] hover:bg-[#1c9a40] rounded-md flex items-center transition-colors"
                                    disabled={isUploading}
                                >
                                    {isUploading ? (
                                        <>
